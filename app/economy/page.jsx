  ...
  return (
    <>
      ...
      {countries.map((c) => {
        ...
        const order = ["cpi", "nfp", "fedfunds", "corecpi", "corepce", "gdp", "unemp", "ppi", "ahe", "eu_cpi", "eu_unemp", "eu_gdp", "uk_cpi", "uk_unemp", "jp_cpi", "china_cpi", "claims", "capacity", "dgs10", "retail", "umich", "indpro", "ismmfg", "ismsvc"];
        const key = order
