...
const GBPUSD_KW = [
  "pound", "sterling", "gbp", "uk", "britain", "bretania", "boe", "uk inflation",
  "dollar", "usd", "fed",
];
const USDJPY_KW = [
  "yen", "jpy", "japan", "boj", "tokyo", "carry trade", "dollar", "usd", "fed",
];
const AUDUSD_KW = [
  "aussie", "aud", "australia", "rba", "dollar", "usd", "fed", "china", "commodity",
];
const USDCAD_KW = [
  "loonie", "cad", "canada", "bo", "oil", "minyak", "dollar", "usd", "fed",
];
const NZDUSD_KW = [
  "kiwi", "nzd", "new zealand", "rbnz", "dollar", "usd", "fed",
];
