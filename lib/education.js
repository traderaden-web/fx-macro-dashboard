...
export const EDUCATION = {
  nfp: {
    ...
    drivers: [
      ...
      { name: "Revisi bulan sebelumnya", detail: "Angka dua bulan lalu sering direvisi setelah survei diperluas. Revisi besar ke bawah melemahkan narasi pasar kerja meski headline bulan berjalan terlihat baik.", data: "Juni 2026 direvisi turun 57 → 20 ribu pada rilis 7 Agu; Mei sudah 129 ribu (angka awal penyedia 172 ribu). 28 Agu: revisi benchmark tahunan BLS −79 ribu (2025: −911 ribu) — level payroll terus direvisi ke bawah.", src: SRC.blsJobs },
  ...
  gdp: {
    ...
    drivers: [
      { name: "Konsumsi rumah tangga", detail: "Komponen terbesar (~70% PDB). Belanja konsumen menentukan laju pertumbuhan.", data: "Q2-2026 (advance, 26 Agu): +1,5% annualized (konsensus 1,5%; Q1: 1,5%) — pertumbuhan stabil, sesuai konsensus.", src: SRC.beaGdp },
  ...
  ismmfg: {
    ...
    drivers: [
      { name: "Permintaan (New Orders)", detail: "New Orders adalah komponen paling forward-looking: pesanan naik = pabrik menambah produksi & tenaga kerja. Pesanan turun biasanya mendahului pemangkasan produksi beberapa bulan.", data: "Juli 2026: 55,6 (konsensus 54,0; sebelumnya 53,3) — beat, manufaktur mempercepat ekspansi (rilis 3 Agu, hari kerja pertama). Juni sebelumnya 53,3 (konsensus 53,8).", src: SRC.ism },
  ...
  ismsvc: {
    ...
    drivers: [
      { name: "Konsumsi rumah tangga", detail: "Sektor jasa adalah proksi langsung belanja konsumen (makanan, kesehatan, perjalanan, jasa keuangan). Services PMI kuat = konsumsi kuat = momentum GDP.", data: "Juni 2026: 54,0 (konsensus 54,2; sebelumnya 54,5); Juli 2026: 54,1 (konsensus 54,5; sebelumnya 54,0) — ekspansi solid, meski dua rilis beruntun di bawah konsensus.", src: SRC.ism },
