...
export const EDUCATION = {
  nfp: {
    ...
    forecast: {
      next: "Kamis, 4 Sep 2026 · 19:30 WIB (hari rilis irreguler — sudah verified di kalender)",
      obs: "Agustus 2026 (data bulan sebelumnya)",
      prev: "−23 ribu (Jul; dirilis 7 Agu)",
      con: "+58 ribu (konsensus)",
      range: "Base 0 – 120 ribu · fokus pasar 30–70 ribu",
  ...
  unemp: {
    ...
    forecast: {
      next: "Kamis, 4 Sep 2026 · 19:30 WIB (bersamaan dengan NFP)",
      obs: "Agustus 2026",
      prev: "4,1% (Jul)",
      con: "4,1% (konsensus)",
      range: "4,0 – 4,2%",
  ...
  cpi: {
    ...
    forecast: {
      next: "Jumat, 11 Sep 2026 · 19:30 WIB",
      obs: "Agustus 2026 (y/y)",
      prev: "3,4% (Jul)",
      con: "±3,2% (estimasi pasar)",
      range: "3,0 – 3,5% headline · core 2,3 – 2,6%",
  ...
  corecpi: {
    ...
    forecast: {
      next: "Jumat, 11 Sep 2026 · 19:30 WIB (rilis yang sama dengan CPI)",
      obs: "Agustus 2026 (y/y)",
      prev: "2,5% (Jul — terendah 5 bulan)",
      con: "±2,4% (estimasi pasar)",
      range: "2,3 – 2,6%",
  ...
  ppi: {
    ...
    forecast: {
      next: "Kamis, 10 Sep 2026 · 19:30 WIB",
      obs: "Agustus 2026 (y/y)",
      prev: "4,7% (Jul)",
      con: "±4,4% (estimasi pasar)",
      range: "4,0 – 4,9%",
  ...
  corepce: {
    ...
    forecast: {
      next: "Selasa, 30 Sep 2026 · 19:30 WIB (ukuran inflasi resmi The Fed)",
  ...
  ahe: {
    ...
    forecast: {
      next: "Kamis, 4 Sep 2026 · 19:30 WIB (dirilis bersamaan dengan NFP)",
      obs: "Agustus 2026 (y/y)",
      prev: "3,15% (Jul)",
      con: "±3,20% (estimasi pasar)",
      range: "3,0 – 3,4%",
  ...
  fedfunds: {
    ...
    forecast: {
      next: "Rabu, 17 Sep 2026 · 01:00 WIB — FOMC + Economic Projections (dot plot); press conference 01:30",
      obs: "Fed Funds Rate (batas atas target range)",
      prev: "3,75% (range 3,50–3,75%)",
      con: "3,75% (hold — base case)",
      range: "Keputusan: hold 3,75% · yang menggerakkan = dot plot & nada pidato",
  ...
  retail: {
    ...
    forecast: {
      next: "Selasa, 15 Sep 2026 · 19:30 WIB",
      obs: "Agustus 2026 (m/m)",
      prev: "−0,6% (Jul — miss jelas vs K +0,1%)",
      con: "±+0,3% (estimasi pasar)",
      range: "−0,2% – +0,8%",
  ...
  umich: {
    ...
    forecast: {
      next: "Tidak ada jadwal aktif (pola: preliminary ~Jumat kedua, 21:00/22:00 WIB — rilis data Aug diperkirakan ±10 Sep)",
      obs: "Agustus 2026",
      prev: "51,0 (Jul — turun dari 55,2 Jun)",
      con: "±51–53 (estimasi pasar)",
      range: "48 – 55",
  ...
  indpro: {
    ...
    forecast: {
      next: "Akhir bulan (laporan G.17, diperkirakan ±25 Sep · 19:30 WIB)",
      obs: "Agustus 2026 (m/m)",
      prev: "0,21% (Jul)",
      con: "±+0,2% (estimasi pasar)",
      range: "+0,1 – 0,3%",
  ...
  gdp: {
    ...
    forecast: {
      next: "Selasa, 30 Sep 2026 · 19:30 WIB — FINAL Q2-2026 (rilis ke-3 dari 3)",
  ...
  claims: {
    ...
    forecast: {
      next: "Setiap KAMIS · 19:30 WIB (mingguan; halaman menampilkan rata-rata bulanan)",
      obs: "Agustus 2026 = rata-rata rilis mingguan Agustus",
      prev: "±204 ribu (rata-rata Agu)",
      con: "±205 ribu (estimasi pasar)",
  ...
  capacity: {
    ...
    forecast: {
      next: "Akhir bulan (rilis G.17 yang sama dengan industrial production, diperkirakan ±25 Sep)",
      obs: "Agustus 2026 (%)",
      prev: "76,3% (Jul)",
      con: "±76,0% (estimasi pasar)",
      range: "75,5 – 77,0%",
  ...
  eu_cpi: {
    ...
    forecast: {
      next: "Pertengahan September (HICP final, diperkirakan ±15 Sep · 14:00 CET; flash awal bulan)",
      obs: "Agustus 2026 (y/y)",
      prev: "2,93% (Jul)",
      con: "±3,0% (proyeksi staff ECB: puncak 3,4% di Q3–Q4)",
      range: "2,8 – 3,2%",
  ...
  eu_unemp: {
    ...
    forecast: {
      next: "Awal bulan (Eurostat, diperkirakan ±7 Sep · 11:00 CET)",
      obs: "Juli 2026",
      prev: "6,3% (Jun)",
      con: "±6,3% (estimasi pasar)",
      range: "6,1 – 6,5%",
  ...
  uk_cpi: {
    ...
    forecast: {
      next: "Pertengahan September (ONS, diperkirakan ±18 Sep · 01:00 WIB)",
      obs: "Agustus 2026 (y/y)",
      prev: "2,9% (Jul)",
      con: "±2,9% (estimasi pasar)",
      range: "2,7 – 3,1%",
  ...
  jp_cpi: {
    ...
    forecast: {
      next: "Akhir September (CPI Tokyo, diperkirakan ±29 Sep) & awal Oktober (nasional, diperkirakan ±3 Okt)",
      obs: "Agustus 2026 (y/y)",
  ...
  eu_gdp: {
    ...
    forecast: {
      next: "Awal bulan (flash Q2, diperkirakan ±1 Sep · 14:00 CET)",
      obs: "Q2-2026 (q/q)",
      prev: "0,3% (Q1)",
      con: "±0,2–0,3% (estimasi pasar; proyeksi 2026 penuh 0,8%)",
      range: "0,0 – 0,5%",
  ...
  china_cpi: {
    ...
    forecast: {
      next: "Awal Oktober (diperkirakan ±10 Okt · 02:00 WIB)",
      obs: "Agustus 2026 (y/y)",
      prev: "0,5% (Jul — deflasi ringan berlanjut)",
      con: "±0,5% (estimasi pasar)",
      range: "0,2 – 0,9%",
  ...
  wti: {
    ...
    forecast: {
      ...
      scenarios: [
        { label: "≥ 90", effect: "Inflasi naik → CAD/NOK naik, JPY/EUR turun.", dir: "up", cur: "CAD·NOK" },
        { label: "80 – 85 (base)", effect: "Premium risiko bertahan → netral.", dir: "flat", cur: "CAD·NOK" },
        { label: "< 80", effect: "Inflasi mendingin → produsen minyak tertekan → CAD/NOK turun.", dir: "down", cur: "CAD·NOK" },
      ],
    },
    drivers: [
  ...
  brent: {
    ...
    forecast: {
      next: "Bergerak HARIAN — mengikuti WTI dengan premium ±US$6–8",
      obs: "Harga spot (harian)",
      prev: "±US$91,4 (30 Agu)",
      con: "—",
      ...
      scenarios: [
        { label: "≥ 95", effect: "Inflasi → CAD/NOK naik, JPY turun.", dir: "up", cur: "CAD·NOK" },
        { label: "85 – 95 (base)", effect: "Stabil → netral.", dir: "flat", cur: "CAD·NOK" },
        { label: "< 80", effect: "Inflasi mendingin → CAD/NOK turun, JPY/EUR pulih.", dir: "down", cur: "CAD·NOK" },
      ],
    },
    drivers: [
  ...
  copper: {
    ...
    forecast: {
      ...
      obs: "Harga spot (harian)",
      prev: "±US$6,56/lb (COMEX; +3,2% sebulan)",
      con: "—",
      ...
      scenarios: [
        { label: "≥ 7,0", effect: "Permintaan global kuat → AUD/NZD naik.", dir: "up", cur: "AUD·NZD" },
        { label: "6,4 – 6,8 (base)", effect: "Stabil → netral.", dir: "flat", cur: "AUD·NZD" },
        { label: "< 5,8", effect: "Risiko resesi global → AUD/NZD turun.", dir: "down", cur: "AUD·NZD" },
      ],
    },
    drivers: [
  ...
  ismmfg: {
    ...
    forecast: {
      next: "Selasa, 1 Sep 2026 · 21:00 WIB (rilis TANGGAL INI)",
      obs: "Agustus 2026",
  ...
  ismsvc: {
    ...
    forecast: {
      next: "Kamis, 4 Sep 2026 · 21:00 WIB (sehari setelah NFP)",
      obs: "Agustus 2026",
      prev: "54,1 (Jul)",
      con: "±54,0 (estimasi pasar)",
      range: "52 – 56",
