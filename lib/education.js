...
export const EDUCATION = {
  nfp: {
    ...
    drivers: [
      ...
      { name: "Revisi bulan sebelumnya", detail: "Angka dua bulan lalu sering direvisi setelah survei diperluas. Revisi besar ke bawah melemahkan narasi pasar kerja meski headline bulan berjalan terlihat baik.", data: "Juni 2026 direvisi turun 57 → 20 ribu pada rilis 7 Agu; Mei dirilis 172 ribu (5 Jun) lalu direvisi turun ke 129 ribu. 28 Agu: revisi benchmark tahunan BLS −79 ribu (2025: −911 ribu) — level payroll terus direvisi ke bawah.", src: SRC.blsJobs },
  ...
  adp: {
    ...
    drivers: [
      ...
      { name: "Kebijakan The Fed", detail: "Pasar kerja yang mendingin memberi The Fed alasan longgar; ADP lemah memperkuat tesis tersebut.", data: "Mei 2026: +122 ribu (konsensus +118 ribu; April +105 ribu) — beat tipis, tapi NFP resmi pekan yang sama justru 172 ribu (kemudian direvisi 129 ribu).", src: SRC.adp },
    ],
    expertViews: [
  ...
  gdp: {
    ...
    drivers: [
      { name: "Konsumsi rumah tangga", detail: "Komponen terbesar (~70% PDB). Belanja konsumen menentukan laju pertumbuhan.", data: "Q2-2026 (advance, 26 Agu): +1,5% annualized (konsensus 1,5%) — stabil. Q1-2026: advance 1,6% → preliminary 2,1% (25 Jun) → final 1,5% (revisi turun 0,6 poin; dikonfirmasi di FF 26 Agu).", src: SRC.beaGdp },
