...
export const EDUCATION = {
  ...
  ismmfg: {
    ...
    drivers: [
      { name: "Permintaan (New Orders)", detail: "New Orders adalah komponen paling forward-looking: pesanan naik = pabrik menambah produksi & tenaga kerja. Pesanan turun biasanya mendahului pemangkasan produksi beberapa bulan.", data: "Juni 2026: PMI 53,3 (konsensus 53,8; sebelumnya 54,0) — di bawah konsensus tapi masih zona ekspansi.", src: SRC.ism },
    ...
    outlook:
      "Per Agustus 2026: manufaktur AS masih berekspansi (Juni 53,3) tapi melambat dari Mei (54,0) dan rilis Juni di bawah konsensus (53,8). Dengan The Fed 'on hold' di 3,75% dan inflasi lengket di 3,4%, pertanyaannya: apakah manufaktur bertahan di atas 50 hingga paruh kedua 2026? Dua rilis beruntun di bawah 50 akan mendorong pasar ke mode 'Fed harus cut' — USD rentan. Selama bertahan di atas 53, cerita pertumbuhan USD tetap utuh; risikonya datang dari subindeks New Orders jika mulai turun di bawah 50.",
    scenarios: [
