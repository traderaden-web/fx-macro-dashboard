...
const CURRENCIES = [
  ...
  { cc: "IDR", key: "id", name: "Rupiah", pairs: ["USD/IDR"] },
  { cc: "CNY", key: "cn", name: "Yuan", pairs: ["USD/CNY"] },
];
...
export function fundamentalBias(strengthByCcy = {}, countryData = COUNTRY_DATA) {
  return CURRENCIES.map((c) => {
    const d = countryData[c.key] || COUNTRY_DATA[c.key];
    if (!d) return null;
