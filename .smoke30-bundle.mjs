...
function Spark({ points, up }) {
  ...
  if (data.length < 2) return /* @__PURE__ */ jsx4("span", { className: "ilt-spark-dim mono", children: "\u2014" });
  ...
  return /* @__PURE__ */ jsxs4("svg", { className: "ilt-spark", width: w, height: h, viewBox: `0 0 ${w} ${h}`, "aria-hidden": "true", children: [
    /* @__PURE__ */ jsx4("polyline", { points: pts, fill: "none", stroke: up ? "var(--up)" : "var(--down)", strokeWidth: "1.6", strokeLinejoin: "round", strokeLinecap: "round" }),
    /* @__PURE__ */ jsx4("circle", { cx: w, cy: h - 2 - (vals[vals.length - 1] - min) / span * (h - 4), r: "2", fill: up ? "var(--up)" : "var(--down)" })
  ] });
}
function IndicatorsClient({ items }) {
  const [q, setQ] = useState2("");
  const [cat, setCat] = useState2("semua");
  const [imp, setImp] = useState2("semua");
  const [cc, setCc] = useState2("semua");
  const [sort, setSort] = useState2("impact-desc");
  ...
  const sortLabel = sort === "impact-desc" ? "DAMPAK HIGH\u2192LOW" : sort === "impact-asc" ? "DAMPAK LOW\u2192HIGH" : sort === "name-asc" ? "NAMA A\u2192Z" : sort === "name-desc" ? "NAMA Z\u2192A" : "NEGARA";
  return /* @__PURE__ */ jsxs4("div", { className: "ilt-term", children: [
    /* @__PURE__ */ jsx4("div", { className: "ct-scan", "aria-hidden": "true" }),
    /* @__PURE__ */ jsxs4("header", { className: "ilt-term-head", children: [
      /* @__PURE__ */ jsxs4("span", { className: "ct-dots", "aria-hidden": "true", children: [
        /* @__PURE__ */ jsx4("i", {}),
        /* @__PURE__ */ jsx4("i", {}),
        /* @__PURE__ */ jsx4("i", {})
      ] }),
      /* @__PURE__ */ jsxs4("span", { className: "ilt-term-title mono", children: [
        "MACROLAB ",
      ...
      /* @__PURE__ */ jsxs4("span", { className: "ilt-term-head-right", children: [
        /* @__PURE__ */ jsxs4("span", { className: "ct-led ok", children: [
          counts.total,
          " INDIKATOR \xB7 DATA RIIL"
        ] }),
        /* @__PURE__ */ jsx4(TermClock, {})
      ] })
    ] }),
    /* @__PURE__ */ jsxs4("section", { className: "ilt-term-sec", children: [
      /* @__PURE__ */ jsxs4("div", { className: "ct-block-head", children: [
        /* @__PURE__ */ jsx4("span", { className: "ct-tag", children: "01" }),
        /* @__PURE__ */ jsx4("h4", { children: "Filter Indikator" }),
      ...
      /* @__PURE__ */ jsxs4("div", { className: "cal-chips-row", children: [
        ...
        /* @__PURE__ */ jsxs4("div", { className: "cal-chips", children: [
          ...
          catList.map((c) => /* @__PURE__ */ jsxs4("button", { className: `cal-chip ${cat === c.id ? "on" : ""}`, onClick: () => setCat(c.id), style: { "--c": c.color }, children: [
            /* @__PURE__ */ jsx4("i", { className: "ilt-cat-dot", "aria-hidden": "true" }),
            c.label.toUpperCase()
          ] }, c.id))
        ] })
      ] }),
      /* @__PURE__ */ jsxs4("div", { className: "cal-chips-row", children: [
        ...
        /* @__PURE__ */ jsxs4("div", { className: "cal-chips", children: [
          ...
          countries.map((c) => /* @__PURE__ */ jsx4("button", { className: `cal-chip ${cc === c.id ? "on" : ""}`, onClick: () => setCc(c.id), title: c.name, children: c.id }, c.id))
        ] })
      ] }),
      /* @__PURE__ */ jsxs4("div", { className: "cal-chips-row", children: [
        /* @__PURE__ */ jsx4("span", { className: "cal-chips-cap mono", children: "URUT" }),
        ...
        ].map((s) => /* @__PURE__ */ jsx4("button", { className: `cal-chip ${sort === s.id ? "on" : ""}`, onClick: () => setSort(s.id), children: s.label }, s.id)) })
      ] }),
      /* @__PURE__ */ jsxs4("div", { className: "cal-search", children: [
        /* @__PURE__ */ jsx4("span", { className: "ct-prompt", "aria-hidden": "true", children: ">" }),
        /* @__PURE__ */ jsx4("input", { type: "text", placeholder: "cari indikator\u2026 (nama, singkatan, negara)", value: q, onChange: (e) => setQ(e.target.value), "aria-label": "Cari indikator" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs4("section", { className: "ilt-term-sec", children: [
      /* @__PURE__ */ jsxs4("div", { className: "ct-block-head", children: [
        /* @__PURE__ */ jsx4("span", { className: "ct-tag", children: "02" }),
        /* @__PURE__ */ jsx4("h4", { children: "Tabel Indikator" }),
        /* @__PURE__ */ jsxs4("span", { className: "ct-block-meta mono", children: [
          "\u25B8 ",
          filtered.length,
          " DARI ",
      ...
      /* @__PURE__ */ jsxs4("div", { className: "ilt-rows", children: [
        filtered.length === 0 && /* @__PURE__ */ jsx4("p", { className: "cal-empty mono", children: "TIDAK ADA INDIKATOR YANG COCOK DENGAN FILTER" }),
        filtered.map((d, i) => {
          const pts = d.points || [];
          ...
          return /* @__PURE__ */ jsxs4(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsx4("span", { className: "ilt-r-idx mono", children: String(i + 1).padStart(2, "0") }),
                /* @__PURE__ */ jsx4("span", { className: "ilt-r-flag", children: /* @__PURE__ */ jsx4(CountryFlag, { code: d.country, size: 20, showCode: false }) }),
                /* @__PURE__ */ jsxs4("span", { className: "ilt-r-name", children: [
                  /* @__PURE__ */ jsx4("b", { children: d.name }),
                  /* @__PURE__ */ jsxs4("i", { className: "mono", children: [
                    d.short,
                    " \xB7 ",
                    d.countryName || d.country
                  ] })
                ] }),
                /* @__PURE__ */ jsxs4("span", { className: "ilt-r-val mono", children: [
                  v === null ? "\u2014" : fmt(v, d.decimals),
                  v !== null && /* @__PURE__ */ jsx4("u", { children: d.unit })
                ] }),
                /* @__PURE__ */ jsx4("span", { className: `ilt-r-trend mono ${trend === null ? "" : trend >= 0 ? "up" : "down"}`, children: trend === null ? "\u2014" : `${trend >= 0 ? "\u25B2 +" : "\u25BC \u2212"}${trend === null ? "" : fmt(Math.abs(trend), d.decimals)}` }),
                /* @__PURE__ */ jsx4("span", { className: "ilt-r-spark", children: /* @__PURE__ */ jsx4(Spark, { points: pts, up: trend !== null && trend >= 0 }) }),
                /* @__PURE__ */ jsxs4("span", { className: "ilt-r-cat", style: { "--c": catMeta?.color }, children: [
                  /* @__PURE__ */ jsx4("i", { "aria-hidden": "true" }),
                  catMeta?.label || d.category
                ] }),
                /* @__PURE__ */ jsxs4("span", { className: `ilt-r-imp ${IMP_CLS[d.impact] || "im-low"}`, title: `Dampak ${d.impact}`, children: [
                  /* @__PURE__ */ jsx4("i", {}),
                  /* @__PURE__ */ jsx4("i", {}),
                  /* @__PURE__ */ jsx4("i", {}),
                  /* @__PURE__ */ jsx4("u", { className: "mono", children: d.impact === "High" ? "HIGH" : d.impact === "Medium" ? "MED" : "LOW" })
                ] }),
                /* @__PURE__ */ jsx4("span", { className: "ilt-r-asof mono", children: d.last?.date?.slice(0, 7) || "\u2014" }),
                /* @__PURE__ */ jsx4("span", { className: "ilt-r-chev", "aria-hidden": "true", children: "\u25B8" })
              ]
            },
            d.id
          );
    ...
    /* @__PURE__ */ jsxs4("footer", { className: "ilt-term-foot mono", children: [
      /* @__PURE__ */ jsxs4("span", { children: [
        "SRC: FRED / CACHE LOKAL \xB7 N: ",
        filtered.length,
        "/",
        counts.total,
        " \xB7 ZONA: WIB (UTC+7)"
      ] }),
      /* @__PURE__ */ jsx4("span", { className: "ilt-term-foot-note", children: "Klik baris untuk riwayat, konsensus vs actual & edukasi lengkap" }),
...
function App() {
  ...
  return /* @__PURE__ */ jsx5(IndicatorsClient, { items });
}
export {
  App as default
};
