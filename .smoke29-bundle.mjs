...
function Chart({ points, height = 260, color = "#38bdf8", unit = "", decimals = 2 }) {
  ...
  if (!data.length) {
    return /* @__PURE__ */ jsx2("div", { ref, className: "chart-empty", style: { height }, children: /* @__PURE__ */ jsx2("span", { children: "Tidak ada data untuk ditampilkan" }) });
  }
  const { w, h } = dims;
  ...
  return /* @__PURE__ */ jsxs("div", { ref, className: "chart-wrap", children: [
    /* @__PURE__ */ jsxs("svg", { width: w, height: h, viewBox: `0 0 ${w} ${h}`, preserveAspectRatio: "none", children: [
      /* @__PURE__ */ jsx2("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: gradId, x1: "0", y1: "0", x2: "0", y2: "1", children: [
        /* @__PURE__ */ jsx2("stop", { offset: "0%", stopColor: color, stopOpacity: "0.32" }),
        /* @__PURE__ */ jsx2("stop", { offset: "100%", stopColor: color, stopOpacity: "0.02" })
      ] }) }),
      ticks.map((t, i) => {
        const yy = y(t);
        return /* @__PURE__ */ jsxs("g", { children: [
          /* @__PURE__ */ jsx2("line", { x1: pad.left, y1: yy, x2: w - pad.right, y2: yy, className: "chart-grid" }),
          /* @__PURE__ */ jsx2("text", { x: pad.left - 8, y: yy + 4, className: "chart-tick", textAnchor: "end", children: fmt2(t) })
        ] }, i);
      }),
      /* @__PURE__ */ jsx2("path", { d: area, fill: `url(#${gradId})` }),
      /* @__PURE__ */ jsx2("path", { d: path, fill: "none", stroke: color, strokeWidth: "2.2", strokeLinejoin: "round", strokeLinecap: "round" }),
      data.map(
        (d, i) => i % labelEvery === 0 || i === data.length - 1 ? /* @__PURE__ */ jsx2("text", { x: x(i), y: h - 8, className: "chart-tick", textAnchor: "middle", children: d.date.slice(0, 7) }, i) : null
      ),
      hover !== null && hd && /* @__PURE__ */ jsxs("g", { children: [
        /* @__PURE__ */ jsx2("line", { x1: hx, y1: pad.top, x2: hx, y2: pad.top + ih, className: "chart-hover-line" }),
        /* @__PURE__ */ jsx2("circle", { cx: hx, cy: hy, r: "4.5", fill: color, stroke: "#0b1220", strokeWidth: "2" })
      ] })
    ] }),
    hover !== null && hd && /* @__PURE__ */ jsxs("div", { className: "chart-tooltip", style: { left: Math.min(hx, w - 170), top: Math.max(hy - 40, 4) }, children: [
      /* @__PURE__ */ jsx2("div", { className: "tt-date", children: hd.date }),
      /* @__PURE__ */ jsxs("div", { className: "tt-value", children: [
        fmt2(hd.v),
        " ",
...
function IconFlag({ size = 16 }) {
  return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", "aria-hidden": "true", children: [
    /* @__PURE__ */ jsx3("path", { ...base, d: "M5 3v18" }),
    /* @__PURE__ */ jsx3("path", { ...base, d: "M5 4h13l-2.5 4 2.5 4H5" })
  ] });
}
function IconGlobe({ size = 16 }) {
  return /* @__PURE__ */ jsxs2("svg", { width: size, height: size, viewBox: "0 0 24 24", "aria-hidden": "true", children: [
    /* @__PURE__ */ jsx3("circle", { ...base, cx: "12", cy: "12", r: "9" }),
    /* @__PURE__ */ jsx3("path", { ...base, d: "M3 12h18" }),
    /* @__PURE__ */ jsx3("path", { ...base, d: "M12 3c2.6 2.5 2.6 15.5 0 18M12 3c-2.6 2.5-2.6 15.5 0 18" })
  ] });
}
...
function ImpactBadge({ level }) {
  ...
  return /* @__PURE__ */ jsx4("span", { className: "badge impact", style: { color: s.c, background: s.bg }, children: level });
}
function CategoryBadge({ id, label, color }) {
  return /* @__PURE__ */ jsxs3("span", { className: "badge cat", style: { color, background: `${color}22` }, children: [
    /* @__PURE__ */ jsx4("span", { className: "dot", style: { background: color } }),
    label
  ] });
}
var CODE_LABEL = {
...
function CountryFlag({ code, size = 16, showCode = true, className = "" }) {
  ...
  return /* @__PURE__ */ jsxs3("span", { className: `country-tag ${isGlobal ? "global" : ""} ${className}`, children: [
    isGlobal ? /* @__PURE__ */ jsx4(IconGlobe, { size }) : /* @__PURE__ */ jsx4(IconFlag, { size }),
    showCode && /* @__PURE__ */ jsx4("span", { className: "country-code", children: label })
  ] });
}
...
function TermClock({ suffix = "WIB" }) {
  ...
  return /* @__PURE__ */ jsxs4("span", { className: "term-clock mono", children: [
    now ? FMT.format(now) : "--:--:--",
    " ",
    suffix
  ] });
...
function App({ id }) {
  const [a, setA] = useState4(null);
  useEffect4(() => {
    getReleaseAnalytics(id).then(setA).catch(() => setA({}));
  }, [id]);
  if (!a || !a.id) return /* @__PURE__ */ jsx6("div", { id: "loading", children: "\u2026" });
  const data = a;
